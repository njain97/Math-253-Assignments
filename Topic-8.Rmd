...
test.Set<-mathAlcohol[-inds, "medv"]
```
...
mean((glm.probs-test.Set)^2)

#The error rate is 0.604
```
...
#Random Forest
mod3 <- randomForest(Dalc ~ . - Walc, data=trainSet, mtry=15, importance=TRUE) 
mod4 <- predict(mod3, data=testSet)
mean((mod4 - test.Set)^2)
```
